...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="relative h-[30rem] md:h-[40rem] w-full border-4 border-[#9B7DD4]/40 bg-[#0a0a0a] rounded-[30px] shadow-2xl overflow-hidden"
    >
      <div className="h-full w-full rounded-2xl bg-[#0d0d1a]">
        {children}
      </div>
    </motion.div>
  );
